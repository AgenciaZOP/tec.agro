    ...
    return (
        <Box sx={{ flexDirection: "column", padding: "10vh 4vw", gap: "3vw", width: "100%", height: "93vh" }}>
            ...
            >
                ...
                <Transactions crop={crop} company="Agrofértil" date={"25/03/2023"} haveSeller />
                <Transactions crop={crop} company="Agrofértil" date={"25/03/2023"} haveSeller={false} />
                <ListTitle title="Transações Pagas" location="paid" />
                <Transactions crop={crop} company="Agrofértil" date={"25/03/2023"} haveSeller={false} />
                <ListTitle title="Transações Pendentes" location="pending" />
                <Transactions crop={crop} company="Safra" date="29/05/200" haveSeller />
            </Box>
        </Box>
    )
}
