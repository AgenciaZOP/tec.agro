...
export const Form: React.FC<FormProps> = ({ user }) => {
    ...
    const handleSubmit = (values: Shipping) => {
        if (shippings.loading) return
        ...
        shippings.new({ ...values, file: image })
                        ...
                        <Formu>
                            ...
                            >
                                ...
                                <Button variant="contained" type="submit">
                                    {shippings.loading ? <CircularProgress color="secondary" size="1.5rem" /> : "Confirmar"}
                                </Button>
                            </Box>
                        </Formu>
                    )}
